...
total.storename as `门店`,
total.branchname as `分行`,
...
from 
(select 
A1.rptdate,A1.buname,A1.partname,A1.storename,A1.branchname,
...
group by A1.rptdate,A1.buname,A1.partname,A1.storename,A1.branchname) total
group by total.buname,total.partname,total.storename,total.branchname
